    ...
    simplify(){
        ...
        switch (this.type){
            ...
            case "Multiply":
                ...
                if (this.term1.constructor == Operator && this.term1.type == "Add") return (new Operator("Add", (new Operator("Multiply", this.term1.term1, this.term2)).simplify(), (new Operator("Multiply", this.term1.term2, this.term2)).simplify())).simplify();
                if (this.term1.constructor == Operator && this.term1.type == "Subtract") return (new Operator("Subtract", (new Operator("Multiply", this.term1.term1, this.term2)).simplify(), (new Operator("Multiply", this.term1.term2, this.term2)).simplify())).simplify();
                if (this.term2.constructor == Operator && this.term2.type == "Add") return (new Operator("Add", (new Operator("Multiply", this.term2.term1, this.term1)).simplify(), (new Operator("Multiply", this.term2.term2, this.term1)).simplify())).simplify();
                if (this.term2.constructor == Operator && this.term2.type == "Subtract") return (new Operator("Subtract", (new Operator("Multiply", this.term2.term1, this.term1)).simplify(), (new Operator("Multiply", this.term2.term2, this.term1)).simplify())).simplify();
                if (this.term1.constructor == Expression && this.term1.constructor == Expression){
                    if (this.term1.type == 'number' && this.term2.type == 'number') return new Expression((BigInt(this.term1.term)*BigInt(this.term2.term)).toString());
                }
                return this;
            ...
            case "Divide":
                if (this.term1.constructor == Expression && this.term1.isZero()) return new Expression("0");
                if (this.term1.constructor == Operator && this.term1.type == "Add") return (new Operator("Add", (new Operator("Divide", this.term1.term1, this.term2)).simplify(), (new Operator("Divide", this.term1.term2, this.term2)).simplify())).simplify();
                if (this.term1.constructor == Operator && this.term1.type == "Subtract") return (new Operator("Subtract", (new Operator("Divide", this.term1.term1, this.term2)).simplify(), (new Operator("Divide", this.term1.term2, this.term2)).simplify())).simplify();
                return this;
            
            case "Power":
                if (this.term2.constructor == Expression && this.term2.isOne()) return this.term1;
                if (this.term1.constructor == Operator && this.term1.type == "Power") return (new Operator("Power", this.term1.term1, (new Operator("Multiply", this.term1.term2, this.term2)).simplify())).simplify();
                return this;

            case "Log":
                if (this.term2.constructor == Operator){
                    if (this.term2.type == "Power") return (new Operator("Multiply", this.term2.term2, new Operator("Log", this.term1, this.term2.term1))).simplify();
                    if (this.term2.type == "Multiply") return (new Operator("Add", new Operator("Log", this.term1, this.term2.term1), new Operator("Log", this.term1, this.term2.term2))).simplify();
                    if (this.term2.type == "Divide") return (new Operator("Subtract", new Operator("Log", this.term1, this.term2.term1), new Operator("Log", this.term1, this.term2.term2))).simplify();
                }
                if (this.term1.term == "e" && this.term2.constructor == Expression){
                    if (this.term2.term == "1") return new Expression("0");
                    if (this.term2.term == "e") return new Expression("1");
                }
                return this;
